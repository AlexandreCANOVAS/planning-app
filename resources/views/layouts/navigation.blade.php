<nav x-data="{ open: false }" class="bg-[rgb(131,44,207)] border-b shadow-sm fixed w-full top-0 z-50">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-1 my-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-[rgb(131,44,207)] hover:text-purple-100 hover:bg-[rgb(141,54,217)] focus:outline-none transition ease-in-out duration-150">
                                <div class="flex items-center">
                                    <div class="h-7 w-7 rounded-full bg-white flex items-center justify-center mr-2">
