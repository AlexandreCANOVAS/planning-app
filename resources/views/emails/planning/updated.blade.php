...
@section('content')
    ...
    <p>Votre planning a été mis à jour.</p>
    ...
    <p>Vous pouvez consulter votre planning mis à jour en cliquant sur le bouton ci-dessous :</p>
    
    <div class="text-center">
        <a href="{{ $url }}" class="btn">Voir mon planning</a>
    </div>
    
    <p class="mt-4">Si vous avez des questions concernant les modifications apportées à votre planning, n'hésitez pas à contacter votre responsable.</p>
