        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('plannings.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="heure_debut" name="heure_debut" type="time" class="mt-1 block w-full" :value="old('heure_debut')" required />
                                    <x-input-error class="mt-2" :messages="$errors->get('heure_debut')" />
                                </div>

                                <div>
                                    <x-input-label for="heure_fin" :value="__('Heure de fin')" />
                                    <x-text-input id="heure_fin" name="heure_fin" type="time" class="mt-1 block w-full" :value="old('heure_fin')" required />
