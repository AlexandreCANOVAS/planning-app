<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    @foreach($employes as $employe)
                        <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 flex flex-col items-center p-4">
                            ...
                            <h3 class="text-md font-semibold text-gray-800 text-center">{{ $employe->prenom }} {{ $employe->nom }}</h3>
                            <p class="text-sm text-gray-500 text-center">{{ $employe->email }}</p>
                            <div class="mt-3 flex space-x-2">
                                <a href="{{ route('employes.show', $employe) }}" class="text-gray-400 hover:text-blue-600" title="Détails">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                </a>
                                <a href="{{ route('employes.edit', $employe) }}" class="text-gray-400 hover:text-yellow-600" title="Modifier">
                    ...
                    @foreach ($invitations as $invitation)
                        <div class="bg-white rounded-xl shadow-sm overflow-hidden flex flex-col items-center p-4 opacity-60 border-2 border-dashed border-gray-300">
                            <div class="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center mb-3">
                                <svg class="h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                            </div>
                            <h3 class="text-md font-semibold text-gray-800 text-center">Invitation en attente</h3>
                            <p class="text-sm text-gray-500 text-center">{{ $invitation->email }}</p>
                            <div class="mt-3">
                    ...
                    @if($employes->isEmpty() && $invitations->isEmpty())
                        <div class="col-span-full bg-gray-50 rounded-xl p-8 text-center">
                            <div class="text-gray-500">
                                <i class="fas fa-users text-4xl mb-4"></i>
                                <p class="text-lg">Aucun employé ou invitation en attente.</p>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            @if(isset($employes) && method_exists($employes, 'links') && $employes->hasPages())
                <div class="mt-6">
