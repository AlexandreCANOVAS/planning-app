                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="statut" name="statut" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="accepte" {{ old('statut', $conge->statut) == 'accepte' ? 'selected' : '' }}>Accepté</option>
                            ...
                            <div>
                                ...
                                <x-text-input id="date_debut" name="date_debut" type="date" class="mt-1 block w-full" :value="old('date_debut', $conge->date_debut)" required />
                                <x-input-error class="mt-2" :messages="$errors->get('date_debut')" />
                            </div>

                            <div>
                                <x-input-label for="date_fin" :value="__('Date de fin')" />
                                <x-text-input id="date_fin" name="date_fin" type="date" class="mt-1 block w-full" :value="old('date_fin', $conge->date_fin)" required />
