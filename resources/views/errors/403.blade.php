...
<div class="relative flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        ...
        <div class="mx-auto">
            <div class="relative">
                <div class="animate-pulse bg-amber-100 dark:bg-amber-900/30 rounded-full h-32 w-32 mx-auto flex items-center justify-center">
                    <span class="text-5xl font-bold text-amber-600 dark:text-amber-400">403</span>
                </div>
