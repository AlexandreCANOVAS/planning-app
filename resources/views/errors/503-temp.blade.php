                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-1 {{ request()->cookie('theme', 'light') === 'dark' ? 'text-yellow-200/70' : 'text-yellow-700' }} text-sm">
                                            {{ isset($exception) && $exception->getMessage() ? $exception->getMessage() : 'Notre équipe technique travaille activement pour rétablir le service le plus rapidement possible.' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
