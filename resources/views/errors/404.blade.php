...
<div class="relative flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        ...
        <div class="mx-auto">
            <div class="relative">
                <div class="animate-pulse bg-purple-100 dark:bg-purple-900/30 rounded-full h-32 w-32 mx-auto flex items-center justify-center">
                    <span class="text-5xl font-bold text-purple-600 dark:text-purple-400">404</span>
                </div>
        ...
        <div class="mt-10 pt-8 border-t border-gray-200 dark:border-gray-700">
            <h2 class="text-lg font-medium text-gray-900 dark:text-white">Suggestions</h2>
            <ul class="mt-4 list-disc list-inside text-sm text-gray-500 dark:text-gray-400 space-y-2">
                ...
                <li>Retournez à la page d'accueil pour recommencer votre navigation</li>
            </ul>
        </div>
    </div>
</div>
